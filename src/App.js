        ...
        <div className="text-center w-full max-w-md">
          ...
          <div className="flex gap-4 justify-center">
            <TransactionCard
                ...
                icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 6H6C4.89543 6 4 6.89543 4 8V16C4 17.1046 4.89543 18 6 18H18C19.1046 18 20 17.1046 20 16V8C20 6.89543 19.1046 6 18 6Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/><path d="M16 4H8C6.89543 4 6 4.89543 6 6V8H18V6C18 4.89543 17.1046 4 16 4Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/><rect x="8" y="10" width="8" height="6" rx="1" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="13" r="1" fill="currentColor"/><path d="M9.5 14.5C9.5 14.5 9 14 9 13.5C9 13 9.5 12.5 9.5 12.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><path d="M14.5 14.5C14.5 14.5 15 14 15 13.5C15 13 14.5 12.5 14.5 12.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>}
